...
//        for(counter =0.1f;counter <= (YEstimate/10) ;counter++){
//
//
//        }
        if (YEstimate <= YMax) {
            ...
            Log.i("££ counter pertama:", String.valueOf(counter-0.099)+"&"+String.valueOf(130.81));

            Log.d("££ cek looper :",  String.valueOf(looper));
            Log.d("££ cek YEstim/10 :",  String.valueOf((int)YEstimate/10));
            ...
            Log.d("££ cekBool:",  String.valueOf(looper == (int)YEstimate/10));
            if(looper <= (int)YEstimate/10){
                mySound.play(raygunID, 1, 1, 1, 0, 1f);

                Log.d("££ counter pertamaCP:", String.valueOf(counter-0.099)+"&"+String.valueOf(130.81));

            }

            // mulai looping
            //ymax = 100
            // counter mulai 0.1 / iterator
            // Yestimate = e.getVal()



//            while(YMax * counter <= YEstimate) {
            while(looper <= (int)(YEstimate/10)) {

                Log.e("££ looper :",  String.valueOf(looper));
                Log.e("££ looper/10 :",  String.valueOf((int)YEstimate/10));

                looper+=1; // digunakan untuk ngitung berapa kali looping

                if (counter >= 0.11 && counter <= 0.21) {
...
//                    counter += 0.1;
                   ...
                   Log.i("££counter 1 <= 0.21:", String.valueOf(counter) + "&" + String.valueOf(130.81*((Math.pow(2, (counter * 20 * 3/ 12))))));
                    ...
                    if(looper == (int)YEstimate/10){
                        mySound.play(raygunID, 1, 1, 1, 0, main);
                        Log.d("££counter 1 CP <= 0.21:", String.valueOf(counter) + "&" + String.valueOf(130.81*((Math.pow(2, (counter * 20 * 3/ 12))))));

                    }



                } else if (counter > 0.21 && counter <= 0.31) {
...
//                    mySound.play(eID, 1, 1, 1, 0, main);
                    ...
                    Log.i("££counter 2 <= 0.31:", String.valueOf(counter) + "&" + String.valueOf(261.62*main));
//                    Log.e("££ dlm main <=0.4 :",  String.valueOf(main));
...
//                    counter += 0.1;
                    ...
                    if(looper == (int)YEstimate/10){
                        mySound.play(eID, 1, 1, 1, 0, main);
                        Log.d("££counter 2CP <= 0.31:", String.valueOf(counter) + "&" + String.valueOf(261.62*main));

                    }

                }else if (counter > 0.31 && counter <= 0.41) {
//                    mySound.play(raygunID, 1, 1, 1, 0, ((float)261.62));
                    main = ((float) (Math.pow(2, (((counter + (counter - 0.1)) * 10 * 3/ 12)-1))));
//                    mySound.play(eID, 1, 1, 1, 0, main);
                    ...
                    Log.i("££counter 3 <= 0.41:", String.valueOf(counter) + "&" + String.valueOf(261.62*main));
//                    Log.e("££ dlm main <=0.4 :",  String.valueOf(main));
...
//                    counter += 0.1;
                    ...
                    if(looper == (int)YEstimate/10){
                        mySound.play(eID, 1, 1, 1, 0, main);
                        Log.d("££counter 3 CP<= 0.41:", String.valueOf(counter) + "&" + String.valueOf(261.62*main));

                    }

                }
                else if (counter > 0.41 && counter <= 0.51) {
                    ...
                    Log.i("££ counter 5 <= 5.1 :", String.valueOf(counter) + "&" + String.valueOf(440*main));
//                    Log.e("££ dlm main <=0.6 :",  String.valueOf(main));
//                    counter += 0.1;
                    try {
                        Thread.sleep(500);
                    } catch (InterruptedException ex) {
                    ...
                    if(looper == (int)YEstimate/10){
                        ...
                        Log.d("££ counter 5 CP<= 5.1 :", String.valueOf(counter) + "&" + String.valueOf(440*main));

                    }

                }
                else if (counter > 0.51 && counter <= 0.61) {
                    main = ((float) (Math.pow(2, ((((counter + (counter - 0.1)) * 10 * 3-21)/ 12)))));
                    mySound.play(aID, 1, 1, 1, 0, main);

                    Log.i("££ counter 6 <= 6 :", String.valueOf(counter) + "&" + String.valueOf(440*main));
//                    Log.e("££ dlm main <=0.6 :",  String.valueOf(main));
//                    counter += 0.1;
                    try {
                        Thread.sleep(500);
                    ...
                    if(looper == (int)YEstimate/10){
                        mySound.play(aID, 1, 1, 1, 0, main);
                        Log.d("££ counter 6CP <= 6 :", String.valueOf(counter) + "&" + String.valueOf(440*main));

                    }
                }
                else if (counter > 0.61 && counter <= 0.71) {
                    main =((float) (Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12)))));

                    mySound.play(a5ID, 1, 1, 1, 0, main);
                    Log.i("££ counter 7 <=0.71:", String.valueOf(counter) + "&" + String.valueOf(880*(Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12))))));
//                    Log.e("££ dlm main <=0.9 :",  String.valueOf(main));
//                    counter += 0.1;
                    ...
                    if(looper == (int)YEstimate/10){
                        mySound.play(a5ID, 1, 1, 1, 0, main);
                        Log.d("££ counter 7CP <=0.71:", String.valueOf(counter) + "&" + String.valueOf(880*(Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12))))));
                    }
                }
                else if (counter > 0.71 && counter <= 0.81) {
                    main =((float) (Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12)))));

                    mySound.play(a5ID, 1, 1, 1, 0, main);
                    Log.i("££ counter 8 <= 0.81 :", String.valueOf(counter) + "&" + String.valueOf(880*(Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12))))));
//                    Log.e("££ dlm main <=0.9 :",  String.valueOf(main));
//                    counter += 0.1;
                    ...
                    if(looper == (int)YEstimate/10){
                        mySound.play(a5ID, 1, 1, 1, 0, main);
                        Log.d("££ counter 8CP<= 0.81:", String.valueOf(counter) + "&" + String.valueOf(880*(Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12))))));

                    }

                }
                else if (counter > 0.81 && counter <= 0.91) {
                    main =((float) (Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12)))));

                    mySound.play(a5ID, 1, 1, 1, 0, main);
                    Log.i("££ counter 9 <= 0.91 :", String.valueOf(counter) + "&" + String.valueOf(880*(Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12))))));
//                    Log.e("££ dlm main <=0.9 :",  String.valueOf(main));
//                    counter += 0.1;
                    ...
                    if(looper == (int)YEstimate/10){
                        mySound.play(a5ID, 1, 1, 1, 0, main);
                        Log.d("££ counter 9CP<= 0.91 :", String.valueOf(counter) + "&" + String.valueOf(880*(Math.pow(2, ((((counter + (counter - 0.2)) * 10 * 3-33)/ 12))))));
                    ...
                    Log.i("££ counter 10 <=1:", String.valueOf(counter) + "&" + String.valueOf(2093*(Math.pow(2, ((((counter + (counter - 0.3)) * 10 * 3-48)/ 12))))));
//                    counter += 0.1;
                    ...
                    if(looper == (int)YEstimate/10){
                        mySound.play(bID, 1, 1, 1, 0, main);
                        Log.d("££ counter 10CP<=1:", String.valueOf(counter) + "&" + String.valueOf(2093*(Math.pow(2, ((((counter + (counter - 0.3)) * 10 * 3-48)/ 12))))));
...
//
//                Log.i("££ Yestimate:", String.valueOf(YEstimate));
//
...
//            if (volume <= 0.21){
//
//                mySound.play(raygunID, 1, 1, 1, 0, ((float) (Math.pow(2, ((counter-0.1) * 20 * 3/ 12)))));
//
////                mySound.play(raygunID, 1, 1, 1, 0, main);
//
////                Log.i("££counter ulang<=2:", String.valueOf(e.getVal())+"&"+String.valueOf(130.81*((float)(Math.pow(2,(volume*20* 3/12))))));
//                Log.i("££counter last <= 2:", String.valueOf(e.getVal())+"&"+String.valueOf(130.81*((float)(Math.pow(2,(volume*20* 3/12))))));
//            }
//            else if (volume > 0.2){
...
//                Log.i("££mainnya last 2 :", String.valueOf(main));
//            }
//            else if (volume > 0.4){
